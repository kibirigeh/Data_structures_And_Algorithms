...
public class ExistsPair {
	...
	public static void main(String[] args) {
		...
		boolean exists = Solution1(nums,sum);//check if a pair exists in nums that sums up to SUM
	 ...
	 */
	public static boolean Solution1(int [] nums,int sum){
	 ...
	 * O(N) worst case
	 */
	public static boolean Solution2(int [] nums,int sum){
